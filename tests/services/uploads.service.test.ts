...
describe('UploadsService', () => {
  ...
  describe('initMultipart', () => {
    it('returns uploadId and key', async () => {
      const result = await service.initMultipart({
        fileName: 'video.mp4',
        fileType: 'video/mp4',
  ...
  describe('getPartUrl', () => {
    it('returns part presigned URL', async () => {
      const result = await service.getPartUrl({
